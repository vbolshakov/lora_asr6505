...
void RadioIrqProcess( void )
{
    if( IrqFired == true )
    {
        ...
        if( ( irqRegs & IRQ_TX_DONE ) == IRQ_TX_DONE )
        {
            ...
            {
//	        printf("going to RadioEvents.TxDone\n");
                RadioEvents->TxDone( );
            }
        }
        ...
        if( ( irqRegs & IRQ_RX_DONE ) == IRQ_RX_DONE )
        {
            ...
            {
//	        printf("going to RadioEvents.RxDone\n");
        ...
        if( ( irqRegs & IRQ_CRC_ERROR ) == IRQ_CRC_ERROR )
        {
            ...
            {
//	        printf("going to RadioEvents.RxError\n");
                RadioEvents->RxError( );
            }
        }
        ...
        if( ( irqRegs & IRQ_CAD_DONE ) == IRQ_CAD_DONE )
        {
            ...
            {
//	        printf("going to RadioEvents.CadDone\n");
        ...
        if( ( irqRegs & IRQ_RX_TX_TIMEOUT ) == IRQ_RX_TX_TIMEOUT )
        {
            if( SX126xGetOperatingMode( ) == MODE_TX )
            {
                ...
                if( ( RadioEvents != NULL ) && ( RadioEvents->TxTimeout != NULL ) )
                {
//		    printf("going to RadioEvents.TxTimeout\n");
                    RadioEvents->TxTimeout( );
                }
            }
            else if( SX126xGetOperatingMode( ) == MODE_RX )
            {
                ...
                if( ( RadioEvents != NULL ) && ( RadioEvents->RxTimeout != NULL ) )
                {
//		    printf("going to RadioEvents.RxTimeout\n");
                    RadioEvents->RxTimeout( );
                }
            }
        }
